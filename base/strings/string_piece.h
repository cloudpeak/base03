...
template <typename STRING_TYPE> class StringPieceDetail {
 ...
 public:
  ...
  void as_string(STRING_TYPE* target) const {
    STRING_TYPE str;
    if (!empty()) {
...
template <> class BasicStringPiece<std::string> :
 ...
 public:
  ...
  bool contains(BasicStringPiece s) const {
  ...
  BasicStringPiece range(size_type pos, size_type end = npos) const {
    return internal::substr(*this, pos, (end == npos) ? npos : end - pos);
  }
};
...
inline base::StringPiece ToStringPiece(const void* data, size_t size) {
