...
class BASE_EXPORT TimeDelta {
 public:
  ...
  static  TimeDelta Infinite() {
    return TimeDelta(kInfiniteTimeUs);
  }

  static int64 InInfiniteTimeUs() {
    return kInfiniteTimeUs;
  }
 ...
 private:
  ...
  // about 30000 years.
  static const int64 kInfiniteTimeUs = 
      GG_LONGLONG(0x7fffffffffffffff) / 10;
